...
export const Navbar: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden sm:flex items-center gap-3">
            <a
              href="#download"
              className="inline-flex items-center gap-2 px-4 py-2 text-xs font-sans font-bold text-white bg-gradient-to-r from-violet-900 via-violet-800 to-indigo-800 hover:from-violet-950 hover:to-indigo-900 rounded-xl shadow-md shadow-violet-900/15 hover:-translate-y-0.5 transition-all duration-200 min-h-[40px]"
            >
          ...
          <button
            ...
            className="lg:hidden p-2 text-slate-700 hover:text-violet-900 rounded-lg hover:bg-violet-100/50 min-w-[44px] min-h-[44px] flex items-center justify-center"
      ...
      {/* Mobile Drawer Menu with accessible touch targets */}
      {mobileMenuOpen && (
          ...
          <div className="flex flex-col gap-1">
            {navLinks.map((link) => (
              <a
                ...
                className="px-4 py-3 text-sm font-sans font-semibold text-slate-800 hover:text-violet-900 hover:bg-violet-100/50 rounded-xl transition-colors min-h-[44px] flex items-center"
              >
                {link.name}
              </a>
            ))}
            <div className="pt-3 border-t border-[#F3EAE0] mt-2">
              <a
                href="#download"
                onClick={() => setMobileMenuOpen(false)}
                className="flex items-center justify-center gap-2 w-full py-3.5 text-sm font-sans font-bold text-white bg-gradient-to-r from-violet-900 to-indigo-800 rounded-xl shadow-md min-h-[44px]"
              >
                <Download className="w-4 h-4 text-amber-200" />
