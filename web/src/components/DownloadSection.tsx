...
export const DownloadSection: React.FC = () => {
  return (
    <section id="download" className="py-20 md:py-28 relative bg-[#FAF8F5] overflow-hidden">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        
        {/* Main Banner Card */}
        <div className="bg-gradient-to-br from-violet-950 via-violet-900 to-indigo-950 rounded-3xl p-8 md:p-14 text-white text-center shadow-2xl shadow-violet-950/20 relative overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto space-y-6 relative z-10">
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/10 border border-white/20">
              ...
              <span className="text-xs font-bold text-violet-100 font-mono tracking-wider">
            ...
            <p className="text-base font-sans text-violet-100 leading-relaxed max-w-2xl mx-auto">
            ...
            <div className="pt-4 flex flex-col items-center justify-center gap-4">
              <a
                ...
                className="group inline-flex items-center justify-center gap-3 px-9 py-4 text-base font-sans font-bold text-violet-950 bg-white hover:bg-amber-100 rounded-2xl shadow-xl hover:-translate-y-1 transition-all duration-200"
              >
                <Download className="w-6 h-6 text-violet-900 group-hover:animate-bounce" />
                <span>Download Android APK</span>
                <span className="text-xs font-mono opacity-80 text-violet-950">({PROJECT_INFO.apkSize})</span>
              </a>

              <div className="flex flex-wrap items-center justify-center gap-4 text-xs text-violet-200 font-mono">
            ...
            <div className="pt-10 border-t border-white/10 text-left">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
                <div className="p-4 rounded-xl bg-white/10 border border-white/10 space-y-1.5">
                  ...
                  <div className="text-[11px] font-sans text-violet-200">Tap the button above from your Android phone browser.</div>
                </div>
